...
class ProductParquetEvalDataset(Dataset):
    ...
    def __init__(self, 
                 ...
                 data_args = None):
        super(ProductParquetEvalDataset, self).__init__()
...
@dataclass
class ProductDataEvalCollator(object):
    """数据收集器，用于批处理"""
    ...
    def __call__(self, instances: List[Dict]) -> Dict[str, torch.Tensor]:
        ...
        answer = [instance['answer'] for instance in instances if 'answer' in instance]
...
if __name__ == "__main__":
    ...
    dataset = ProductParquetEvalDataset(data_path, tokenizer=tokenizer, prompt_type='single_product_title_prompt')
